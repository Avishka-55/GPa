...
">
  ...
  ✅ Total Credits Counted: <b style="color:#00B049;">${result.totalCredits}</b><br>
  📊 Final GPA Score: <b style="color:#00B049;">${result.gpa}</b><br>
  🏅 Awarded Class: <b style="color:#00B049;">${className}</b>
</span>
